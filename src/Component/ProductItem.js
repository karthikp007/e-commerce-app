...
export default function ProductItem({ item }) {
  ...
  function handleDelelteProduct(item) {
    let url = `https://my-json-server.typicode.com/karthikp007/data/products/${item.id}`;
  ...
  return (
    //   container
    <div className="d-flex container-sm bg-white px-1 py-5 mt-4 flex-column flex-lg-row gap-4 rounded">
      {/* left section  */}
      <ToastContainer />
