...
export default function AddProduct() {
  ...
  let url = "https://my-json-server.typicode.com/karthikp007/data/products";
  ...
  return (
    // container
    <Container className="bg-light border border-1 border-dark mt-4 p-3 rouunded">
      <ToastContainer />
      <form className="d-flex flex-column gap-3" onSubmit={handleSubmit}>
        ...
        <button
          ...
          style={{
            width: "9rem",
            backgroundColor: "var(--addProduct)",
          }}
        >
          Add to Cart
        </button>
